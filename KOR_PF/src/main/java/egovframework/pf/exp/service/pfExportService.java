...
public interface pfExportService {
	...
	void saveTempExpMakeInList2(List<SaveExpInvoiceVO> voList, UserSessionVO userVO) throws Exception;

	String selectTempInvoiceMainIdex2(String index) throws Exception;

	void saveTempExpMakeInSubList2(List<SaveExpInvoiceVO> voList, UserSessionVO userVO, String mainSeq2) throws Exception;
	...
	void deleteTempExpMakeInList2(SearchVO schVo2) throws Exception;

	void deleteTempExpMakeInSubList2(SearchVO schVo2) throws Exception;
