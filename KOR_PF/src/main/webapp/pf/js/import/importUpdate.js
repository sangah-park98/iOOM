...
function fn_impUpTableCol(){
	...
	this.impUpCol = [
		...
		{data : 'seq', className : "htCenter",width: 100, wordWrap: false, readOnly:true},
		{data : 'reqDay', className : "htCenter", width: 110, wordWrap: false, readOnly:true},
		...
		{data : 'customs', className : "htCenter",width: 150, wordWrap: false, readOnly:true},
		{data : 'petDay', className : "htCenter",width: 120, wordWrap: false, readOnly:true},
		{data : 'plntCd', className : "htCenter", width: 120, wordWrap: false, readOnly:true},
...
function fn_impUpTableHeader(){
	var tableType = $("input:radio[name=importUpType]:checked").val();
	this.impUpHeader =  [
		status, nabFirm, blNo, rptNo, correctionSeq, applicationDt, approvalDt, correctionType,
		failReason, correctionReason, TaxVariation, taxPrice, additonalDuties, customs, lisDay, factoryCd, po, "SN"
...
function fn_impDtlUpdTableCol(){
	this.impDtlUpdCol = [
		...
		{data : 'excKeyNo', className : "htCenter", width: lang === 'en' ? 210 : 100, wordWrap: false, readOnly:true},
		{data : 'expRptNo', className : "htCenter", width: lang === 'en' ? 200 : 100, wordWrap: false, readOnly:true},
		{data : 'expRanNo', className : "htCenter", width: 100, wordWrap: false, readOnly:true},
		{data : 'expSilNo', className : "htCenter", width: lang === 'en' ? 160 : 100, wordWrap: false, readOnly:true},
		{data : 'contSeq', className : "htCenter", width: 100, wordWrap: false, readOnly:true},
		{data : 'imdtSeq', className : "htCenter", width: lang === 'en' ? 130 : 100, wordWrap: false, readOnly:true},
...
function fn_impDtlUpdViewTableHeader(){
	this.impDtlUpdViewHeader = [
		rptNo, lanNo, specNo, correctionName, correctionBefore, correctionAfter, approvalNo,
		nonApprovalNo, reExpRptNo, reExpRan, reExpSpec, container, InstantOutbound, orderNo
