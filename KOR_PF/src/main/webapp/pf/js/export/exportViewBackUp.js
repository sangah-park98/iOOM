...
function fn_expViewLanTableCol(){
	this.expViewLanCol = [
		...
		{data : 'incorterms', className : "htCenter", width: 100, wordWrap: false, className : "htCenter"},
...
function fn_expViewLanTableHeader(){
	this.expViewLanHeader = [
		"신고번호","란번호","Invoice번호","세번부호","거래품명","결제금액","순중량","포장갯수","원산지", "인코텀즈", "첨부"
	];
}
	...
	exportViewSettings = {
	 ...
	 // columnSorting : {indicator : true},
      ...
      afterOnCellMouseDown : function(event, coords){
    	  ...
    	  var sn = dataList[dataList.length-1].sn;
