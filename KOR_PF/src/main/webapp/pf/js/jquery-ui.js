...
$.widget( "ui.tabs", {
	...
	options: {
		active: null,
		/*
		 * classes: { "ui-tabs": "ui-corner-all", "ui-tabs-nav":
		 * "ui-corner-all", "ui-tabs-panel": "ui-corner-bottom", "ui-tabs-tab":
		 * "ui-corner-top" },
		 */
		collapsible: false,
		event: "click",
	...
	_processTabs: function() {
		...
		/* nav ul 클래스제거 */
		/*
		 * this._addClass( this.tablist, "ui-tabs-nav", "ui-helper-reset
