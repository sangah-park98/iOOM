...
$( document ).ready(function() {
	  ...
	  $("#itemViewSrchType3 option").remove();
	  $("#itemViewSrchType3").append('<option value="">조건선택</option>');
	  $("#itemViewSrchType3").append('<option value="rptNo">신고번호</option>');
	  $("#itemViewSrchType3").append('<option value="cmpnyNm">납세의무자/수출자</option>');
	  $("#itemViewSrchType3").append('<option value="hsCode">HSCODE</option>');
	  $("#itemViewSrchType3").append('<option value="taxKi">세종</option>');
	  $("#itemViewSrchType3").append('<option value="ut">단위</option>');
	  $("#itemViewSrchType3").append('<option value="plntCd">부서코드</option>');
	  $("#itemViewSrchType3").append('<option value="prOrdr">PO</option>');
	  $("#itemViewSrchType3").append('<option value="blNo">B/L</option>');
	  $("#itemViewSrchType3").append('<option value="saleOrder">SO</option>');
	  $("#itemViewSrchType3").append('<option value="invoice">Inovice</option>');
	  
	  $("#itemViewSrchType4 option").remove();
	  $("#itemViewSrchType4").append('<option value="">조건선택</option>');
	  $("#itemViewSrchType4").append('<option value="rptNo">신고번호</option>');
	  $("#itemViewSrchType4").append('<option value="cmpnyNm">납세의무자/수출자</option>');
	  $("#itemViewSrchType4").append('<option value="hsCode">HSCODE</option>');
	  $("#itemViewSrchType4").append('<option value="taxKi">세종</option>');
	  $("#itemViewSrchType4").append('<option value="ut">단위</option>');
	  $("#itemViewSrchType4").append('<option value="plntCd">부서코드</option>');
	  $("#itemViewSrchType4").append('<option value="prOrdr">PO</option>');
	  $("#itemViewSrchType4").append('<option value="blNo">B/L</option>');
	  $("#itemViewSrchType4").append('<option value="saleOrder">SO</option>');
	  $("#itemViewSrchType4").append('<option value="invoice">Inovice</option>');
...
$("input[name=itemView_srch1]").change(function(){
    ...
    if(selectedValue === "01") {
      ...
      $("#itemViewSrchType3 option").remove();
  	  $("#itemViewSrchType3").append('<option value="">조건선택</option>');
  	  $("#itemViewSrchType3").append('<option value="rptNo">신고번호</option>');
  	  $("#itemViewSrchType3").append('<option value="cmpnyNm">납세의무자</option>');
  	  $("#itemViewSrchType3").append('<option value="hsCode">HSCODE</option>');
  	  $("#itemViewSrchType3").append('<option value="taxKi">세종</option>');
  	  $("#itemViewSrchType3").append('<option value="ut">단위</option>');
  	  $("#itemViewSrchType3").append('<option value="plntCd">부서코드</option>');
  	  ...
  	  $("#itemViewSrchType4").append('<option value="">조건선택</option>');
  	  $("#itemViewSrchType4").append('<option value="rptNo">신고번호</option>');
  	  $("#itemViewSrchType4").append('<option value="cmpnyNm">납세의무자</option>');
  	  $("#itemViewSrchType4").append('<option value="hsCode">HSCODE</option>');
  	  $("#itemViewSrchType4").append('<option value="taxKi">세종</option>');
  	  $("#itemViewSrchType4").append('<option value="ut">단위</option>');
  	  $("#itemViewSrchType4").append('<option value="plntCd">부서코드</option>');
      ...
      $("#itemViewSrchType3 option").remove();
  	  $("#itemViewSrchType3").append('<option value="">조건선택</option>');
  	  $("#itemViewSrchType3").append('<option value="rptNo">신고번호</option>');
  	  $("#itemViewSrchType3").append('<option value="cmpnyNm">수출자</option>');
  	  $("#itemViewSrchType3").append('<option value="hsCode">HSCODE</option>');
  	  $("#itemViewSrchType3").append('<option value="taxKi">세종</option>');
  	  $("#itemViewSrchType3").append('<option value="ut">단위</option>');
  	  $("#itemViewSrchType3").append('<option value="plntCd">부서코드</option>');
  	  ...
  	  $("#itemViewSrchType4").append('<option value="">조건선택</option>');
  	  $("#itemViewSrchType4").append('<option value="rptNo">신고번호</option>');
  	  $("#itemViewSrchType4").append('<option value="cmpnyNm">수출자</option>');
  	  $("#itemViewSrchType4").append('<option value="hsCode">HSCODE</option>');
  	  $("#itemViewSrchType4").append('<option value="taxKi">세종</option>');
  	  $("#itemViewSrchType4").append('<option value="ut">단위</option>');
  	  $("#itemViewSrchType4").append('<option value="plntCd">부서코드</option>');
...
function fn_searchItemViewLan2(){
	var lData = {};
	//LanItemCode = itemViewLanHot.getDataAtRow(0)[13];
	console.log(LanItemCode);
	lData["srch2"] = LanItemCode;
	
	lData["srchType3"] = $("#itemViewSrchType3 option:selected").val();
	lData["srchText3"] = $("#itemViewSrchText3").val();
	lData["srchType4"] = $("#itemViewSrchType4 option:selected").val();
	lData["srchText4"] = $("#itemViewSrchText4").val();
...
//검색조건 초기화
function fn_clearItemView2(){
	
	$("#itemViewSrchType3").val("");
	$("#itemViewSrchType4").val("");
...
function fn_itemViewLanTableCol(){
	...
	this.itemViewLanCol =(searchTp == "01" && (tableType == "read" || tableType == "edit")) ?[
		...
		{data : 'cmpnyNm', className : "htCenter", width: 110, wordWrap: false},
...
function fn_itemViewLanTableHeader(){
	...
	this.itemViewLanHeader = (searchTp == "01" && (tableType == "read" || tableType == "edit")) ? [
		"신고번호","납세의무자/수출자", "란","규격","신고일자","수리일자","HSCODE",
		"세종","세율","수량","단위","단가","원산지표시유무","자재코드","부서코드","PO","B/L","SO","Invoice","result"
	] : (searchTp == "02" && (tableType == "read" || tableType == "edit")) ? [
		"신고번호","납세의무자", "란","규격","신고일자","수리일자","HSCODE",
		"세종","세율","수량","단위","단가","원산지표시유무","자재코드","부서코드","PO","B/L"
	] : (searchTp == "03" && (tableType == "read" || tableType == "edit")) ? [
		"신고번호","수출자","란","규격","신고일자","수리일자","HSCODE",
    ...
    //마우스 클릭시 자재코드에 맞는 란 규격 보여주기
      afterOnCellMouseDown: function(event, coords) {
    	    ...
    	    if (col > 0) {
    	        ...
    	        LanItemCode = itemcode;
    	        fn_searchItemViewLan(itemcode);
    	        
    	        // 이전에 포커스된 행에서 포커스 제거
    	        if (currentFocusedRow > -1) {
    	            removeRowFocus(currentFocusedRow);
    	        }
...
//행 전체에 포커스를 추가하는 함수
function addRowFocus(row) {
    const colCount = itemViewHot.countCols(); // 전체 열의 개수
    for (let col = 0; col < colCount; col++) {
        const cell = itemViewHot.getCell(row, col);
        if (cell) {
            Handsontable.dom.addClass(cell, 'htRowFocused');
        }
    }
}

// 이전에 포커스된 행에서 포커스를 제거하는 함수
function removeRowFocus(row) {
    const colCount = itemViewHot.countCols(); // 전체 열의 개수
    for (let col = 0; col < colCount; col++) {
        const cell = itemViewHot.getCell(row, col);
        if (cell) {
            Handsontable.dom.removeClass(cell, 'htRowFocused');
        }
    }
}
