...
$(document).ready(function() {
	...
	$("a, .py-1 rounded hover").click(function(){
		...
		if (find_id == tabs_id || tabs_id =="tabs-tabs-dashboard") {
			...
			if(tabs_id =="tabs-tabs-dashboard"){
				$("#tabs-dashboard").prop("class","nav-link tab-button inline-flex" + tabWidthClass + "bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
			} else {
				$("#" + tabs_id).prop("class","nav-link tab-button inline-flex" + tabWidthClass + "bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
			}
			// 아닐경우
		} else {
			...
			var target = $("#" + fId)[0];
			li = "<li class='nav-item z-1 shrink-0 bg-primary-50 relative'><a class='nav-link tab-button inline-flex" + tabWidthClass + "bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active' id='"
					+ id
	...
	tabs.on("click","img.ui-icon-close",function() {
		...
		if (length < 2) {
			...
			lastObj.className = "nav-link tab-button inline-flex" + tabWidthClass + "bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor";
		}
	});
...
function fn_openInovice(){
	...
	if (find_id == tabs_id || tabs_id =="tabs-tabs-dashboard") {
		...
		$(".nav-link").removeClass("active");
		$("#myTab").find("a").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 ui-tabs-anchor");
		$("#tabs-exportMakeIn").prop("class","nav-link tab-button inline-flex" + tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
...
function fn_openInoviceTemp2(invoiceNo){
...
function fn_openPacking(shipper, address, invoiceNo,  invoiceDate, consignee, loadingPort, flight, final, inDepDate, rowData, consigneeAddress, comments){
	...
	if (find_id == tabs_id || tabs_id =="tabs-tabs-dashboard") {
		...
		$("#myTab").find("a").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
		$("#" + tabs_id).prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
		// 아닐경우
	} else {
...
$(".nav-link").removeClass("active");
	...
	if (find_id == tabs_id || tabs_id =="tabs-tabs-dashboard") {
		...
		$(".nav-link").removeClass("active");
		$("#myTab").find("a").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 ui-tabs-anchor");
		$("#tabs-mainNotice").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
		tabs.tabs("option", "active", id2Index2("#tabs", tab_id));
...
function go_news(){
	...
	if (find_id == tabs_id || tabs_id =="tabs-tabs-dashboard") {
		...
		$(".nav-link").removeClass("active");
		$("#myTab").find("a").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 ui-tabs-anchor");
		$("#tabs-news").prop("class","nav-link tab-button inline-flex"+ tabWidthClass +"bg-gray-200 border-gray-300 rounded-t-lg border-t border-l border-r items-center justify-center p-2 t-lg hover:text-gray-600 hover:border-primary-800 group gap-2 active ui-tabs-anchor");
		tabs.tabs("option", "active", id2Index2("#tabs", tab_id));
			// 아닐경우
	} else {
		var tabWidthClass = " w-44 ";
