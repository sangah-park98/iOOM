...
<head>
	<meta charset="UTF-8" />
	<script src="/pf/js/3rd/plugins/echarts.min.js"></script>
	<script src="/pf/js/3rd/scripts/echarts.script.min.js"></script>
	<script src="/pf/js/3rd/plugins/apexcharts.min.js"></script>
	<script src="/pf/js/3rd/plugins/apexcharts.dataseries.js"></script>
...
<body class="text-left" id="dashboard">
    ...
    <section class="p-2 text-lg w-full h-full flex flex-col justify-between shrink overflow-hidden z-0">
      ...
      <div class="flex items-center justify-between mb-2 px-2 gap-4 w-full shrink-0">
        ...
        <!-- Status Tabs -->
        <c:if test="${!author.equals('Client Basic')}">
        <a href="#"
      ...
      <div class="w-full h-full grid grid-rows-[minmax(16rem,auto)_12rem] grid-cols-12 gap-x-2 gap-y-2 justify-between p-2 border rounded-xl text-slate-800 overflow-hidden">
        ...
        <div class="row-start-1 col-span-6 col-start-7 flex flex-col items-start justify-start">
         <div class="flex items-center gap-1 w-full justify-between">
          <h3 class="font-semibold my-2 truncate flex items-center gap-1 shrink-0">
            <i class="fa-regular fa-chart-line-up"></i>수출&수입 그래프</h3>
         <ul id="chartType" class="relative  flex flex-wrap -m-1 gap-1" style="text-align:center;">
          <li onclick="fn_rptType('01');" class="status-tab-exp active relative inline-flex items-center justify-center gap-1 font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-primary-50 text-slate-500 duration-150 ease-in-out cursor-pointer">
            <i class="fa-duotone fa-box-taped mr-1"></i>수출
          </li>
          <li onclick="fn_rptType('02');" class="status-tab-imp relative inline-flex items-center justify-center gap-1 font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-primary-50 text-slate-500 duration-150 ease-in-out cursor-pointer">
            ...
            <div class="w-full h-[255px] overflow-auto">
		           <div class="myChartClass" >
		          	<canvas id="myChart" height="255"></canvas>
		          </div>
          </div>
        </div>
        ...
        <div class="row-start-2 col-span-6 col-start-7 flex flex-col items-start justify-start">
          <h3 class="font-semibold my-2 truncate flex items-center gap-1 shrink-0 w-full">
            <i class="fa-regular fa-list"></i>통관담당자&전담관세사
          </h3>
