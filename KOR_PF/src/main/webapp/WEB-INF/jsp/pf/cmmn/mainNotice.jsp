...
<head>
 ...
 <script src="/pf/js/cmmn/mainNotice.js" charset="UTF-8"></script>
...
<div id="noticeTitlePopUp" class="modal fixed top-0 left-0 h-full w-full z-[200] bg-black/50 items-center justify-center flex" style="display: none;">
  ...
  <div class="notice-modal modal-content bg-white shadow-xl relative rounded max-w-[800px] min-w-[42rem] overflow-hidden" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
	  ...
	  <div class="mx-5 py-4 border-t-2 flex justify-between gap-2">
	    ...
	    <div class="flex gap-2">
	        <button type="button" id="noticeEdit" onclick="noticeUpdate()"
	        		style="display: none" class="block py-2 px-3 font-semibold text-center text-white border border-secondary-700 bg-secondary-700 rounded-lg hover:bg-secondary-800 focus:ring-4 focus:ring-secondary-300 dark:bg-secondary-600 dark:hover:bg-secondary-700 dark:focus:ring-secondary-800 leading-6">
	                       수정
	        </button>
	        <button type="button" id="noticeDelete" onclick="noticeDelete()"
	        		style="display: none" class="block py-2 px-3 font-semibold text-center text-white border-red-500 bg-red-500 rounded-lg focus:ring-4 focus:ring-secondary-300 dark:bg-secondary-600">
	                      삭제
	        </button>
	...
	<form name="noticeFileDownForm" method="post"
...
<div class="pl-6 pr-0 py-0 flex items-center justify-between">
    <h2 class="font-bold text-xl mr-3">&nbsp;내용 </h2>
    <div class="flex items-center">
        <h2 class="font-bold text-xl mr-3">상단 고정</h2>
        <input type="checkbox" id="noticeType" style="margin-right: 25px;">
    </div>
</div>
