...
<script src="/pf/js/import/importUpdate.js" charset="UTF-8"></script>
<script src="/pf/js/import/importUpdateCalendar.js" charset="UTF-8"></script>
</head>
...
<main class="p-2 grow flex flex-col gap-2">
  ...
  <input type="hidden" id="grpCd" value="${grpCd}">
    ...
    <input type="text"  id="importUp_srch5" onkeyup="enterkey()"
    ...
    <label
      for="n3"
      class="row-start-4 col-start-7 flex items-center font-medium text-gray-900 px-2
    ">
      PO번호
    </label>
    <input
      ...
      id="importUp_srch7"
      onkeyup="enterkey()"
      class="row-start-4 col-span-5 col-start-8 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg
      focus:ring-primary-500 focus:border-primary-500 block px-2.5 py-1"
  ...
  <div class="flex items-center justify-between w-full shrink-0">
    <div class="flex items-center gap-4" id="importUp_div6">
      ...
      <p class="shrink-0 flex items-center gap-1">결과
			: <span id="importUpCnt">0</span>
		</p>
      <!-- <label for="default-radio-7">
        <input id="default-radio-7" type="radio" value="read" name="importUpType" checked
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>읽기</span>
      </label> -->
      <!-- <label for="default-radio-8">
        <input id="default-radio-8" type="radio" value="e" name="default-radio"
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>등록</span>
      </label>
      <label for="default-radio-9">
        <input id="default-radio-9" type="radio" value="e" name="default-radio"
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>편집</span>
      </label> -->
    </div>
    ...
    <c:if test="${!grpCd.equals('Client Basic') && !grpCd.equals('Client Advanced')}">
      <!-- <a href="#" class="text-base text-primary-600 hover:underline" onclick="fn_importUpdateExcelDownload()">Excel 다운로드</a> -->
      	<button
	      	type="button"
	      	onclick="fn_importUpdateExcelDownload()"
...
<!--       <button
        type="button"
        class="upload-button h-9 text-white bg-primary-700 hover:bg-secondary-800 font-medium rounded px-2.5 py-2 text-base border border-primary-700 hover:border-secondary-400"
      >
...
<form id="importUpdateForm" action="" method="post">
</form>
<footer class="w-full
