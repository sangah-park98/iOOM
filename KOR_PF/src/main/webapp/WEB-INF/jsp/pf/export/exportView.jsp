...
<main class="p-2 grow flex flex-col gap-2">
  <form class="w-full shrink-0 grid grid-rows-3 grid-cols-[auto_repeat(5,1fr)_auto_repeat(5,1fr)]
	...
	<div class="flex items-center justify-between">
	  	<p class="card-title inline" style="line-height: 39px; white-space: nowrap;">1. 당일수출신고요약</p>
	  	<div class="flex items-center gap-2">
	    	...
	    	<select
	      		id="exportViewPageCnt"
	      		name="exportViewPageCnt"
...
<div id="expTodayViewTable" class="grow bg-gray-100 shadow-inner rounded-lg border border-slate-300"></div>

<p class="card-title inline">2. 수출신고현황 결과: <span id="exportViewCnt">0</span></p>
<div id="exportViewTable" class="grow bg-white shadow-sm rounded-lg border border-slate-200 z-0"></div>

<p class="card-title inline" style="line-height: 39px">3. 수출신고진행현황</p>
<div id="expProcessTable" class="grow bg-white shadow-sm rounded-lg border border-slate-200 z-0"></div>
