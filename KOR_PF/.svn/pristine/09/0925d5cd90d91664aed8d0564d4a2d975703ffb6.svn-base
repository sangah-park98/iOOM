...
function fn_itemViewTableHeader() {
	return [
         // 		물품 정보									거래 현황
		[{ label: itemGoodsInfo, colspan: 3 }, { label: transactionStatus, colspan: 3 }, { label: 'HS CODE', colspan: 2 }, 
         { label: restrictedItem, colspan: 1 }, { rowspan: 2 }],
         //			수출입규제대상
         [hsCode, goodsName, description, itemUnit, itemPrice, itemAvgPrice, "HS CODE", hsCodeType, requirement,
          itemHsStatus, itemCheckList, firstLisday, lastLisday]
         /*["자재코드", "거래품명", "Description(규격, 성분포함)", "거래물량(단위)", "거래금액(통화)", "평균단가", "HS CODE", "HS CODE 종류", "요건",
...
function fn_itemCodeChk(row, col) {
    ...
    <input type="text" id="memo" class="flex-1 p-2 border rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm resize-none" rows="1" placeholder="${msgInputInspectionRsn}">
    `
	...
	document.querySelector('.itemCodeChkTitle').textContent = hsCode + ": " + rowData.itemCode;
	var iData = {};
...
function fn_handsonGridItemCodeChkOption() {
	itemCodeChkElementSettings = {
        ...
        rowHeaders: true,
        columnHeaderHeight: 25,
        colHeaders: [goodsName, "Description", transUnit, currency, "HS CODE"],
...
function fn_itemMemoTableHeader(tableType) {
	this.itemMemoHeader = [checkDt, insepctor, memo, itemCheckList];
...
function fn_itemChkDetailTableHeader() {
	this.itemChkDetailHeader = ["", "Description", transUnit, currency, "HS CODE"];
...
function fn_itemChkDetailDel() {
	...
	if (cnt == 0){
    	alert(msgSelectInspectHistory); // "삭제할 점검이력을 선택해 주세요."
    	return;
    }
	
	if (confirm(msgDelInspectionHistory)) { // "선택한 점검이력을 삭제하시겠습니까?"
		$.ajax({
			type : "POST",
...
var itemHsCodeDiffCol = [
	...
	{data: 'rptNo', className: "htCenter", width: lang === 'en' ? 110 : 100, wordWrap: false, readOnly:true},
	{data: 'ran', className: "htCenter", width: 100, wordWrap: false, readOnly:true},
	{data: 'sil', className: "htCenter", width: 100, wordWrap: false, readOnly:true},
	{data: 'taxKi', className: "htCenter", width: 100, wordWrap: false, readOnly:true},
	{data: 'gsRate', className: "htRight", width: 100, wordWrap: false, readOnly:true},
	{data: 'price', className: "htRight", width: lang === 'en' ? 110 : 80, wordWrap: false, readOnly:true},
	{data: 'currency', className: "htCenter", width: lang === 'en' ? 130 : 110, wordWrap: false, readOnly:true},
...
var itemHsCodeDiffHeader = [
	hsCode, "HS CODE", goodsName, nabFirm, rptNo, lanNo, specNo,
	taxType, taxRate, settlingPrice, curOfSettlement, taxPaid, reporter
...
function fn_itemPriceTableHeader(){
	this.itemPriceHeader = ["", hsCode, maxPrice, minPrice, avgPrice];
...
function fn_searchItemOutOfRate(itemCode){
	...
	if(itemOutOfRateVal > 100 ) { 
		alert(msgZeroToHundred); // "0~100 이하의 값만 유효합니다."
		return false;
	}
	itemRptNoHot.loadData([]);
...
function fn_itemRptNoTableCol(){
	...
	this.itemRptNoCol =(searchTp == "01") ? [
		...
		{data : 'ran', className : "htCenter", width: lang === 'en' ? 110 : 100, wordWrap: false, readOnly:true},
		{data : 'sil', className : "htCenter", width: lang === 'en' ? 140 : 100, wordWrap: false, readOnly:true},
		{data : 'lisDay', className : "htCenter", width: lang === 'en' ? 120 : 100, wordWrap: false, readOnly:true},
		{data : 'itemCode', className : "htCenter", width: 100, wordWrap: false, readOnly:true},
		{data : 'upi', className : "htCenter", width: lang === 'en' ? 130 : 80, wordWrap: false, readOnly:true},
		{data : 'ut', className : "htCenter", width: lang === 'en' ? 120 : 50, wordWrap: false, readOnly:true},
		{data : 'conKi', className : "htCenter", width: lang === 'en' ? 100 : 50, wordWrap: false, readOnly:true},
		{data : 'supFirm', className : "htCenter", width: 150, wordWrap: false, readOnly:true},
		{data : 'currency', className : "htCenter", width: lang === 'en' ? 160 : 50, wordWrap: false, readOnly:true},
		{data : 'wonPrice', className : "htCenter", width: lang === 'en' ? 110 : 90, wordWrap: false, readOnly:true},
		{data : 'avgPrice', className : "htCenter", width: lang === 'en' ? 130 : 90, wordWrap: false, readOnly:true},
		{data : 'unitDiff', className : "htCenter", width: lang === 'en' ? 200 : 90, wordWrap: false, readOnly:true}
		...
		{data : 'itemCode', className : "htCenter", width: 100, wordWrap: false, readOnly:true},
		{data : 'upi', className : "htCenter", width: lang === 'en' ? 110 : 80, wordWrap: false, readOnly:true},
...
function fn_itemRptNoTableHeader(){
	this.itemRptNoHeader = [
		nabFirm, blNo, rptNo, lanNo, specNo, lisDay, hsCode,
		declartionPrice, declartionUnit, curOfMethod, overseas, curOfSettlement, wonPrice, itemAvgPrice, priceAvgDiff
...
var itemLawCdCol = [
	{data: 'itemCode', className: "htCenter", width: lang === 'en' ? 110 : 80, wordWrap: false, readOnly:true},
	{data: 'hs', className: "htCenter", width: 80, wordWrap: false, readOnly:true},
	{data: 'goodsName', className: "htLeft", width: 230, wordWrap: false, readOnly:true},
	{data: 'cmpnyNm', className: "htCenter", width: 100, wordWrap: false, readOnly:true},
	{data: 'cont', className: "htCenter", width: lang === 'en' ? 260 : 100, wordWrap: false, readOnly:true},
	{data: 'includeCnt', className: "htCenter", width: lang === 'en' ? 170 : 50, wordWrap: false, readOnly:true},
	{data: 'excludeCnt', className: "htCenter", width: lang === 'en' ? 190 : 50, wordWrap: false, readOnly:true},
	{data: 'rptNo', className: "htCenter", width: lang === 'en' ? 140 : 100, wordWrap: false, readOnly:true},
	{data: 'ranNo', className: "htCenter", width: lang === 'en' ? 60 : 50, wordWrap: false, readOnly:true},
	{data: 'sil', className: "htCenter", width: lang === 'en' ? 120 : 50, wordWrap: false, readOnly:true},
	{data: 'document', className: "htRight", width: lang === 'en' ? 160 : 100, wordWrap: false, readOnly:true},
	{data: 'approvalNo', className: "htRight", width: lang === 'en' ? 180 : 70, wordWrap: false, readOnly:true},
	{data: 'excludeCd', className: "htCenter", width: lang === 'en' ? 160 : 60, wordWrap: false, readOnly:true},
	{data: 'excludeReason', className: "htCenter", width: lang === 'en' ? 160 : 100, wordWrap: false, readOnly:true},
	{data: 'reporter', className: "htCenter", width: 90, wordWrap: false, readOnly:true}
];

var itemLawCdHeader = [
	hsCode, "HS CODE", goodsName, nabFirm, customsCheckTarget, includeRequirement, excludeRequirement,
	rptNo, lanNo, specNo, requirementDocu, approvalNo, excludeCd, excludeReason, reporter
