...
<main class="p-2 grow flex flex-col gap-2">
 ...
 <!--   
    <div class="row-start-1 col-start-10 px-4 flex items-end gap-2">
    ...
    <div
      class="row-start-1 col-span-2 col-end-13 flex flex-row gap-2 items-end justify-end"
    > -->
 ...
 <div class="row-start-1 col-start-7 col-span-6 flex items-end justify-end gap-4">
	...
	<!--   <div class="flex items-center gap-2">
	    <input onclick="fn_checkboxClick()" 
	           name="itemView_srch13" id="default-checkbox" type="checkbox" value="01" 
  ...
  <!-- 검색 버튼 -->
    ...
    ">
      <option selected value="01">최종 수리일자</option>
      <option value="02">최초 수리일자</option>
    </select>
    <!-- Calendar -->
    <div
...
<!--     <label
    ...
    <select
      id="itemViewSrchType1" style="width:100px;"
      ...
      <option value="saleNo">거래품명</option>
      <option value="itemCode">자재코드</option>
      <option value="desCirp">Description</option>
      <option value="reporter">신고인</option>
    </select>
    <input
      type="text"
      id="itemViewSrchText1"
      onkeyup="enterkey()" 
    ...
    >
    <select
      id="itemViewSrchType2" style="width:100px;"
      class="row-start-3 col-start-7 col-span-1 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block px-1 py-1">
      <option value="" selected>조건선택</option>
      <option value="saleNo">거래품명</option>
      <option value="itemCode">자재코드</option>
      <option value="desCirp">Description</option>
    ...
    <input
      type="text"
      id="itemViewSrchText2"
      onkeyup="enterkey()"
      class="row-start-3 col-span-5 col-start-8 bg-gray-50 border border-gray-300 text-gray-900
  ...
  <div class="flex items-center justify-between w-full shrink-0">
    <div class="flex items-center gap-4">
      <h2 id="itemTextView" class="shrink-0 flex items-center gap-1"><i class="fa-duotone fa-chart-network text-primary-900"></i></h2>
  ...
  >
    ...
    <select
      id="itemViewSrchType3" style="width:100px;"
      class="row-start-2 col-start-1 col-span-1 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block px-1 py-1">
    </select>
    <input
      type="text"
      id="itemViewSrchText3"
      onkeyup="enterkey2()" 
    ...
    >
    <select
      id="itemViewSrchType4" style="width:100px;"
      class="row-start-2 col-start-7 col-span-1 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block px-1 py-1">
    </select>
    <input
      type="text"
      id="itemViewSrchText4"
      onkeyup="enterkey2()"
      class="row-start-2 col-span-5 col-start-8 bg-gray-50 border border-gray-300 text-gray-900
      text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block px-2.5 py-1"
      placeholder=""
    >
