...
function fillNewsModalContent(resultList) {
    ...
    var activationButton = document.querySelector('#newsActive');
    if (news.active === 'Y') {
        activationButton.textContent = '비활성화';
        activationButton.classList.remove('bg-secondary-700');
        activationButton.classList.add('bg-red-500', 'border-red-500');
    } else if (news.active === 'N') {
        activationButton.textContent = '활성화';
        activationButton.classList.remove('bg-red-500', 'border-red-500');
        activationButton.classList.add('bg-secondary-700', 'border-secondary-700');
    }
