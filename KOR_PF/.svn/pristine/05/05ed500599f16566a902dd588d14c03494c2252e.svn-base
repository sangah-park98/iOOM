...
function fn_expViewTableCol(){
	...
	this.expViewCol = [
		...
		{data : 'taStIso', className : "htCenter", width: lang === 'en' ? 150 : 130, wordWrap: false, className : "htCenter", readOnly:true},
		...
		{data : 'jukDay', className : "htCenter", width: lang === 'en' ? 180 : 160, wordWrap: false, className : "htCenter", readOnly:true},
...
function fn_expViewLanTableCol(){
	this.expViewLanCol = [
		...
		{data : 'ranNo', className : "htCenter", width: 80, wordWrap: false, className : "htCenter"},
		...
		{data : 'packCnt', className : "htCenter", width: lang === 'en' ? 150 : 110, wordWrap: false, className : "htCenter"},
...
function fn_expViewSpecTableCol(){
	this.expViewSpecCol = [
		...
		{data : 'sil', className : "htCenter", width: lang === 'en' ? 120 : 80, wordWrap: false, className : "htCenter"},
...
function fn_expProgressTableCol(){
	this.expProgressCol = [
		{data : 'acptDt', className : "htCenter", width: 125, wordWrap: false, readOnly:true,
			renderer: function(instance, td, row, col, prop, value, cellProperties) {
            if (value) {
		...
		{data : 'csclWght', className : "htCenter", width: lang === 'en' ? 110 : 100, wordWrap: false, readOnly:true},
		...
		{data : 'shpmWght', className : "htCenter", width: lang === 'en' ? 110 : 100, wordWrap: false, readOnly:true},
	];
}
