...
function fn_searchImportView(){
	importViewIndex = 0;
	$("#impViewSrch2").val($("#importView_srch2").val());
	$("#impViewSrch3").val($("#importView_srch3").val());
	$("#impViewSrch4").val($("#importView_srch4").val());
	$("#impViewSrch5").val($("#importView_srch5").val());
	$("#impViewSrch6").val($("#importView_srch6").val());
	$("#impViewSrch7").val($("#importView_srch7").val());
...
function fn_setImportViewForm(){
	...
	sData["srch6"] = $("#importView_srch6").val();
	sData["srch7"] = $("#importView_srch7").val();
...
function fn_clearImportView(){
	...
	$("#importView_srch6").val("");
	$("#importView_srch7").val("");
...
function fn_impViewLanTableCol(){
	this.impViewLanCol = [
		{data : 'rptNo', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'ranNo', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'hs', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'na', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'gsRate', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'stdGname1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'excGname1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'taxUsd', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true},
		{data : 'csChkCot', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'gs', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'vat', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
	];
}

function fn_impViewLanTableHeader(){
	this.impViewLanHeader = [
		"신고번호","란번호","세번부호","구분","세율","품명","거래품명","과세가격미화","CS","관세","부가세"
	];
}

function fn_impViewSpecTableCol(){
	this.impViewSpecCol = [
		{data : 'sil', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'impGname1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'qty', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'ut', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'upi', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'amt', wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'impGname2', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'compoent1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'compoent2', className : "htCenter", wordWrap: false, className : "htCenter"},
		];
}

function fn_impViewSpecTableHeader(){
	this.impViewSpecHeader = [
		"규격번호","품명","수량","단위","단가","금액","품명2","성분1","성분2"
		];
}
...
function fn_handsonGridImpViewListPopupOption() {
	impViewListPopupSettings = {
        ...
        hiddenColumns: { copyPasteEnabled: false, indicators: false, columns: [4] },
...
function fn_importViewExcelDownload(){
	 ...
	 $("#importViewForm").html("");
	 $("#importViewForm").attr("action","/import/importViewdownloadExcel.do");
	 
	//검색조건
	$.each(fn_setImportViewForm(),function(attrName,attrValue){
	 $("#importViewForm").append("<input type='hidden' value=" + attrValue + " name=" + attrName + ">");
	});
	...
	exCol = fn_getExcelCol(impViewCol.impViewCol); 
    exTit = fn_getExcelHead(impViewHeader.impViewHeader); 
    
    $("#importViewForm").append("<input type='hidden' name='exCol' value="+ exCol +">");
    $("#importViewForm").append("<input type='hidden' name='exTit' value="+ exTit +">");
    $("#importViewForm").append("<input type='hidden' name='exType' value="+ type +">");
