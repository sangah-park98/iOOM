...
function fn_searchImportUp(){
	...
	$.ajax({
        ...
        success : function(data) {
            	...
            	$("#importUpCnt").text(data.totCnt.toLocaleString()); //검색결과 총 갯수
        	fn_loading(false);
        },
        error : function(e, textStatus, errorThrown) {
        	if(e.status == 400){
...
function fn_impUpTableCol(){
	...
	this.impUpCol = [
		...
		{data : 'plntCd', className : "htCenter", width: 100, wordWrap: false, readOnly:true},
		{data : 'prOrdr', className : "htCenter", width: 100,wordWrap: false, readOnly:true},
		{data : 'rece', className : "htCenter", width: 100,wordWrap: false, readOnly:true,renderer : chipRenderer},
		{data : 'rptSeq', className : "htCenter",width: 50, wordWrap: false, readOnly:true},
		{data : 'reasonDoc1', className : "htCenter",width: 180, wordWrap: false, readOnly:true},
		{data : 'cs', className : "htCenter",width: 60, wordWrap: false, readOnly:true},
		{data : 'rptNo', className : "htCenter", width: 150,wordWrap: false, readOnly:true},
		{data : 'blno', className : "htCenter", width: 100,wordWrap: false, readOnly:true},
		{data : 'nabFirm', className : "htCenter", width: 120,wordWrap: false, readOnly:true},
		{data : 'supFirm', className : "htCenter", width: 100,wordWrap: false, readOnly:true},
		{data : 'step01Date', className : "htCenter", width: 100,wordWrap: false, readOnly:true},
		...
		{data : 'banchulday', className : "htCenter", width: 90,wordWrap: false, readOnly:true},
		{data : 'excCot', className : "htCenter",width: 120,wordWrap: false, readOnly:true},
		{data : 'conKiCot', className : "htCenter",width: 120, wordWrap: false, readOnly:true},
		{data : 'conCod', className : "htCenter", width: 60,wordWrap: false, readOnly:true},
		{data : 'freKrw', wordWrap: false,width: 60, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'insuKrw', wordWrap: false,width: 60, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true },
		{data : 'totWt', className : "htCenter",width: 100, wordWrap: false, readOnly:true},
		{data : 'totPackCnt', className : "htCenter",width: 80, wordWrap: false, readOnly:true},
...
function fn_impUpTableHeader(){
	...
	// 사용여부
	this.impUpHeader =  [
		"importCheck", "공장코드", "PO", "상태","차수", "정정사유", "C/S검사", "신고번호", "B/L번호", "납세자", "무역거래처", "적하목록제출", "반입일자", "신고일자", "수리일자", "반출일자", "거래구분",
		"결제방법", "인코텀즈", "운임", "보험료", "총중량", "총포장개수", "통화단위", "신고금액", "화물진행정보", "요건승인", "해외공급자국가부호", "적출국(부호)", "FTA적용여부", "감면여부", "확정신고대상여부",
		"사용자메모"
	 ] ;
}
