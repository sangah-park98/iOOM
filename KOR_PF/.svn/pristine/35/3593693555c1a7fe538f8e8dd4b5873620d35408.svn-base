...
<head>
  ...
  <script src="/pf/js/docu/documentCalendar.js" charset="UTF-8"></script>
  ...
  <form class="w-full shrink-0 grid grid-rows-3 grid-cols-[auto_repeat(5,1fr)_auto_repeat(5,1fr)]
    ...
    <div
      ...
      <div class="relative grow">
        ...
        <input name="documentView1_date" type="text" id="documentView_srch2"
      ...
      <div class="relative grow">
        ...
        <input name="documentView2_date" type="text" id="documentView_srch3"
               class="text-base bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 py-1 px-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 "
    ...
    <input type="text" id="documentView_srch8"
  ...
  <div class="flex items-center justify-between w-full shrink-0">
    <div class="flex items-center gap-4">
      <h2 class="shrink-0 flex items-center gap-1">
        ...
        결과: <span id="documentViewCnt">${totCnt}</span>
      </h2>
    </div>
...
<div id="docuDownloadPopUp" class="modal fade fixed top-0 left-0 h-full w-full z-[200] bg-black/50 items-center justify-center duration-300" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: none;">
	<div class="modal-close absolute top-0 left-0 w-full h-full"></div>
		<div class="modal-dialog modal-xl" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width:1220px;" >
			<div class="modal-content bg-white shadow-lg relative rounded min-w-80 overflow-hidden">
			<div class="pl-7 pr-5 py-2 text-white bg-primary-900 flex items-center justify-between">
