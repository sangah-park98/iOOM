...
<head>
  ...
  <script src="/pf/js/export/exportUpdate.js" charset="UTF-8"></script>
  <script src="/pf/js/export/exportUpdateCalendar.js" charset="UTF-8"></script>
</head>
...
<main class="p-2 grow flex flex-col gap-2">
  <form class="w-full shrink-0 grid grid-rows-3 grid-cols-[auto_repeat(5,1fr)_auto_repeat(5,1fr)]
    ...
    ">
      <div class="relative grow">
        ...
        <input id="exportUpdate_srch2" name="exportUpdate1_date" type="text"
    ...
    <input type="text" id="exportUpdate_srch6"
    ...
    <input type="text" id="exportUpdate_srch7"
  ...
  <div class="flex items-center justify-between w-full shrink-0">
    <div class="flex items-center gap-4">
      <h2 class="shrink-0 flex items-center gap-1"><i class="fa-duotone fa-chart-network text-primary-900"></i>정정신고 현황</h2>
      <p class="card-title inline" style="line-height: 39px">결과
			: <span id="exportUpdateCnt">0</span>
	  </p>
     <!--  <label for="default-radio-7">
        <input id="default-radio-7" type="radio" value="read" name="exportUpdateType" checked="checked"
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>읽기</span>
      </label> -->
      <!-- <label for="default-radio-8">
        <input id="default-radio-8" type="radio" value="enrol" name="exportUpdateType"
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>등록</span>
      </label>
      <label for="default-radio-9">
        <input id="default-radio-9" type="radio" value="edit" name="exportUpdateType"
              class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <span>편집</span>
      </label> -->
    </div>
  ...
  <!-- MainTable -->
  <div id="exportUpdateTable" class="grow bg-white shadow-sm min-h-[32rem] rounded-lg border border-slate-200 z-0"></div>
  <!-- MainTable -->
</main>
