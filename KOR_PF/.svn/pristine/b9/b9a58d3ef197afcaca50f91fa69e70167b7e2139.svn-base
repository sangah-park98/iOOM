...
public class pfExportServiceImpl extends EgovAbstractMapper implements pfExportService {
	...
	@Override
	public int selectExportInTotCnt(SearchVO vo) throws Exception {
		return pfExportMapper.selectExportInTotCnt(vo);
	}
	@Override
	...
	@Override
	public int selectExportViewTotCnt(SearchVO vo) throws Exception {
		return pfExportMapper.selectExportViewTotCnt(vo);
	}
	@Override
	public int selectExportUpdateTotCnt(SearchVO vo) throws Exception {
		return pfExportMapper.selectExportUpdateTotCnt(vo);
	}
	@Override
	...
	@Override
	public void expPopupDeleteList(SearchVO vo) throws Exception {
		pfExportMapper.expPopupDeleteList(vo);
	}
	@Override
