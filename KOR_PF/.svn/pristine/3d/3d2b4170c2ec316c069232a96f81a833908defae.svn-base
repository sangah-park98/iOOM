...
function fn_expViewLanTableCol(){
	this.expViewLanCol = [
		...
		{data : 'ranNo', className : "htCenter", width: 160, wordWrap: false, className : "htCenter"},
		{data : 'hs', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'excGnm', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'conAmt', className : "htCenter", wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true},
		{data : 'sunWt', className : "htCenter", wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true},
		{data : 'packCnt', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'oriStMark1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'invoice', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'attYn', className : "htCenter", wordWrap: false, className : "htCenter"},
	];
}
...
function fn_expViewSpecTableCol(){
	this.expViewSpecCol = [
		...
		{data : 'gnm1', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'qty', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'price', className : "htCenter", wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true},
		{data : 'amt', className : "htCenter", wordWrap: false, type : 'numeric', className: 'htRight', numericFormat : {pattern : '0,0'}, readOnly:true},
		{data : 'gnm2', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'gnm3', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'gnm4', className : "htCenter", wordWrap: false, className : "htCenter"},
		{data : 'gnm5', className : "htCenter", wordWrap: false, className : "htCenter"},
	];
}

function fn_expViewSpecTableHeader(){
	this.expViewSpecHeader = [
		"규격번호","품명","수량","단가","금액","품명2","품명3","품명4","품명5"
	];
}
...
function fn_exportViewExcelDownload(){
	 ...
	 $("#exportViewForm").html("");
	 $("#exportViewForm").attr("action","/export/exportViewdownloadExcel.do");
	 
	//검색조건
	$.each(fn_setExportViewForm(),function(attrName,attrValue){
	 $("#exportViewForm").append("<input type='hidden' value=" + attrValue + " name=" + attrName + ">");
	});
	...
	exCol = fn_getExcelCol(expViewCol.expViewCol); 
    exTit = fn_getExcelHead(expViewHeader.expViewHeader); 
    
    $("#exportViewForm").append("<input type='hidden' name='exCol' value="+ exCol +">");
    $("#exportViewForm").append("<input type='hidden' name='exTit' value="+ exTit +">");
    $("#exportViewForm").append("<input type='hidden' name='exType' value="+ type +">");
    
	
    $("#exportViewForm").submit();
