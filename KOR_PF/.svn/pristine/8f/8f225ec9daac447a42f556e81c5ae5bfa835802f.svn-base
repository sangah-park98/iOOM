...
<script src="/pf/js/rpt/deadLine.js" charset="UTF-8"></script>
<script src="/pf/js/rpt/deadLineCalendar.js" charset="UTF-8"></script>
...
<main class="p-2 grow flex flex-col gap-2">
  ...
  <input type="hidden" id="grpCd" value="${grpCd}">
    ...
    ">
      <div class="relative grow">
        ...
        <input name="deadLineView1_date" 
        		id="deadLineView_srch2"
        		type="text"
      ...
      <div class="relative grow">
        ...
        <input 
        name="deadLineView1_date"
        type="text"
        id="deadLineView_srch3"
        class="text-base bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 py-1 px-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 "
        placeholder="종료일자">
      </div>
    </div>
    ...
    <select type="text" id="n1"
     ...
     <label
      for="deadLineView_srch9"
      class="row-start-4 col-start-1 flex items-center font-medium text-gray-900 pr-2"
    >
      공장코드
    </label>
    <input
      type="text"
      id="deadLineView_srch9"
      onkeyup="enterkey()"
    ...
    <!-- SO 번호 -->
    <label
      for="deadLineView_srch8"
      class="row-start-4 col-start-7 flex items-center font-medium text-gray-900 px-2 export-view"
    >
    SO 번호
    </label>
    <input
      type="text"
      id="deadLineView_srch8"
      onkeyup="enterkey()"
      class="row-start-4 col-start-8 col-span-5 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-500 focus:border-primary-500 block py-1 px-2.5 export-view"
  ...
  <div class="flex items-center justify-between w-full shrink-0">
    <div class="flex items-center gap-4">
      <h2 id="importtextView" class="shrink-0 flex items-center gap-1">
      <i class="fa-duotone fa-feather text-primary-900"></i>
		    수입
		</h2>
      <!-- <p class="text-gray-500 text-base">결과:<span id="deadLineViewCnt">0</span> -->
