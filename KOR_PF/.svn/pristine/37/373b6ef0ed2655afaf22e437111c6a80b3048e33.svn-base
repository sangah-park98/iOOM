...
public interface ImportService {
	...
	int selectImportBlListCnt(SearchVO vo) throws Exception;
	...
	int selectImportViewListCnt(SearchVO vo) throws Exception;
	...
	int selectImportUpdateListCnt(SearchVO vo) throws Exception;
